...
project_name = "same_energy_test_high_corrected"
...
J = 6
lr = 1e-1
scale_factors = [["1,1,1,1,1,1"], ["1.4,1,1,1,1,1"], ["10,1,1,1,1,1"], ["0.1,1,1,1,1,1"]]
...
experiment_names = []
for name, scale_factor in zip([1, 1.4, 2, 0.7], scale_factors):
